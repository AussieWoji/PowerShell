...
Function GetInfo {
      ...
      [string[]]$computername, 
      [string]$logfile = '$env:USERPROFILE\Documents\WindowsPowerShell\GetInfo-Server\unreachable.txt',
      [string]$outfile = '$env:USERPROFILE\Documents\WindowsPowerShell\GetInfo-Server\computerinfo.csv'
