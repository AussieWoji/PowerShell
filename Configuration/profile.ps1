<#
Based on profile from Steve Lee SteveL-MSFT
...
$gistUrl = "https://api.github.com/gists/d5b224b1e4164c0e6274f8a5672a6616"
...
if (Test-Path $latestVersionFile) {
  ...
  $currentProfile = Get-Content $PROFILE.CurrentUserAllHosts -Raw
...
$null = Start-ThreadJob -Name "Get version of `$PROFILE.CurrentUserAllHosts from gist" -ArgumentList $gistUrl, $latestVersionFile, $versionRegEx -ScriptBlock {
